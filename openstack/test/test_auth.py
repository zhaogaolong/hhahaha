...
# You may page a copy of the License at
#
...
class AuthenticateAgainstKeystoneTests(utils.TestCase):
    def test_authenticate_success(self):
        cs = client.Client("admin", "admin", "project_id",
                           "http://192.168.1.106:8776/v1", service_type='volume')
        resp = {
            "access": {
                "token": {
                ...
                "serviceCatalog": [
                    {
                        ...
                        "endpoints": [
                            {
                                "region": "beijing",
                                "adminURL": "http://192.168.1.106:8776/v1",
                                "internalURL": "http://192.168.1.106:8776/v1",
                                "publicURL": "http://192.168.1.106:8776/v1",
                            },
                        ],
                    },
                ],
...
if __name__ ==  '__main__':
    a = AuthenticateAgainstKeystoneTests()
    a.test_authenticate_success()
